        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div id="for_numrows" class="for_numrows text-right" style="display: inline;"><label for="numrows">' +
            ...
            **/
            if (
                ...
                var filterbyDiv =
                    '<div id="for_filter_by" class="for_filter_by text-right" style="display: inline;"><label for="filter_by">' +
                    translate(voc_filter_by) +
                    ': </label><select id="filter_by"></select> &nbsp&nbsp<input id="filter_input" type="text" placeholder="' +
